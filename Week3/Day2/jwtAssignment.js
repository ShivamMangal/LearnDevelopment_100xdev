...
const ans2 = decodeJwt(
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InNoaXZhbUBnbWFpbC5jb20iLCJpYXQiOjE3NjE0OTM5Nzd9.IWATK_iHj7bpkVDJ6cgGg4uxiPzq8ibqxW0iDDvUxyM"
);
console.log(ans2);

function verifyJwt(token) {
    try{
         jwt.verify(token, jwtPassword);   //verfiy: fasle pr exception throw krta ha islia try catch use kia
         return true;
    }
    catch(e){
        return false;
